...
## S019 — audit/pwv2-swarm-luba8a4q8jb2nbtv2i2mra8w

### S019-F01 — DONE status bypasses result validity and blocking review gates

- Source branch: `audit/pwv2-swarm-luba8a4q8jb2nbtv2i2mra8w`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: Research / Intake / tracker / external-side-effect recovery; plugin / install / update / SessionStart / bootstrap drift; path traversal / locator safety / cross-workstream binding; review independence / review bypass / result mutation
...
### S019-F02 — Immutable Git identities are declarative and do not protect same-path content changes
...
### S019-F03 — A terminal GREEN review can finalize with nonexistent verdict evidence
...
### S019-F04 — Research may redirect its own return owner by contradicting origin_role
...
### S019-F05 — Review acceptance identity is path-only, so changed active Card acceptance can reuse stale GREEN
...
#### S019 original confidence and limitations
...
## S020 — audit/pwv2-swarm-m7q2v9x4c1k8r6p3n0t5h2z7

### S020-F01 — Explicit Brainstorming user stop is bypassed once Definition exists

- Source branch: `audit/pwv2-swarm-m7q2v9x4c1k8r6p3n0t5h2z7`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: 7. Planning / Premium gates / Execution precedence; 2. malformed or contradictory state / fail-closed behavior; 9. Research / Intake / tracker / external-side-effect recovery; 4. review independence / review bypass / result mutation
...
### S020-F02 — Implementation Research can return to an unrelated or nonexistent Card
...
### S020-F03 — Satisfied Planning gates are not bound to the current Definition revision
...
### S020-F04 — Setting a Card to DONE bypasses REQUIRED review and contradictory blocker state
...
### S020-F05 — Commit/blob identity is compared as metadata but never verified against actual bytes
...
### S020-F06 — A satisfied JIT trigger is ignored by all-DONE routing to Close
...
### S020-F07 — GREEN review can finalize with a nonexistent durable evidence artifact
...
#### S020 original confidence and limitations
...
## S021 — audit/pwv2-swarm-ni3axnsfbpabhyhjgl2dy7q4

### S021-F01 — Pre-repair issue diagnosis is incorrectly converted into an alignment stop

- Source branch: `audit/pwv2-swarm-ni3axnsfbpabhyhjgl2dy7q4`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: plugin / install / update / SessionStart / bootstrap drift; Research / Intake / tracker / external-side-effect recovery; Close / finalization / end-of-approved-scope; malformed or contradictory state / fail-closed behavior
...
### S021-F02 — Intake prior-art proof can be fabricated with any non-empty string
...
### S021-F03 — DONE Cards route to Close without dereferencing result, contract, or required review state
...
### S021-F04 — SessionStart accepts stale/counterfeit router content if two marker strings survive
...
#### S021 original confidence and limitations
...
## S022 — audit/pwv2-swarm-novka0hlkl74xbxwtotil5iz

### S022-F01 — DONE status bypasses required/RED review and routes Close

- Source branch: `audit/pwv2-swarm-novka0hlkl74xbxwtotil5iz`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: review independence / review bypass / result mutation; malformed or contradictory state / fail-closed behavior; stale commit/blob/path/result/review identity; Task Board / READY / active / DONE / JIT-trigger lifecycle
...
### S022-F02 — Same-path result mutation can reuse stale GREEN because Git identity is not verified
...
### S022-F03 — Missing terminal review evidence still permits finalization
...
### S022-F04 — Satisfied JIT trigger is ignored when all Cards are DONE, routing Close
...
#### S022 original confidence and limitations
...
## S023 — audit/pwv2-swarm-o9x9kt40jy3l8lsxhgj5posd

### S023-F01 — DONE can bypass durable-result validation and mandatory review

- Source branch: `audit/pwv2-swarm-o9x9kt40jy3l8lsxhgj5posd`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: plugin / install / update / SessionStart / bootstrap drift; Planning / Premium gates / Execution precedence; RED / recovery / blocker / interrupted-runtime continuation; helper vs documented semantics / parity drift / negative space
...
### S023-F02 — Immutable Git subjects are only syntactically checked, so GREEN review can cover mutated content
...
### S023-F03 — editorial_exempt is self-attested and can suppress Plan Review for an arbitrary changed plan
...
### S023-F04 — Blocked Card state outranks a durable result, allowing replay despite recovery truth
...
#### S023 original confidence and limitations
...
## S024 — audit/pwv2-swarm-os2xq9rsnl22hac1qcjfptsz

### S024-F01 — READY dependency content can drift behind an unchanged exact locator

- Source branch: `audit/pwv2-swarm-os2xq9rsnl22hac1qcjfptsz`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: malformed or contradictory state / fail-closed behavior; stale commit/blob/path/result/review identity; helper vs documented semantics / parity drift / negative space; Research / Intake / tracker / external-side-effect recovery
...
### S024-F02 — GREEN implementation review survives mutation of its Task Card acceptance surface
...
### S024-F03 — Unrelated Research can preempt the mandatory Intake diagnosis prior-art binding
...
### S024-F04 — Plan Review accepts an unrelated authority path as the plan acceptance surface
...
### S024-F05 — Semantically failed or unverifiable Card Results are accepted as durable recovery truth
...
### S024-F06 — A satisfied JIT trigger is dropped behind the all-DONE route to Close
...
### S024-F07 — DONE status bypasses REQUIRED review, including pending review
...
#### S024 original confidence and limitations
...
## S025 — audit/pwv2-swarm-q7m2v9k4x1c8n5r0t6p3zjhw

### S025-F01 — Path-only Card results can be accepted as durable completion truth

- Source branch: `audit/pwv2-swarm-q7m2v9k4x1c8n5r0t6p3zjhw`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: stale commit/blob/path/result/review identity; RED / recovery / blocker / interrupted-runtime continuation; Close / finalization / end-of-approved-scope; helper vs documented semantics / parity drift / negative space
...
### S025-F02 — Exact-looking commit/blob tuples are never verified against the bytes being consumed
...
### S025-F03 — Contradictory Card status + durable result is accepted and can replay work
...
### S025-F04 — RECOMMENDED review has no activation state, so every recommendation becomes mandatory
...
### S025-F05 — Declared stop precedence is not enforced when pre-execution Research is present
...
#### S025 original confidence and limitations
...
## S026 — audit/pwv2-swarm-qiegju16x0nv1c3tz4ls8wss

### S026-F01 — Terminal `done` Card state bypasses REQUIRED/RED review gates

- Source branch: `audit/pwv2-swarm-qiegju16x0nv1c3tz4ls8wss`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: Close / finalization / end-of-approved-scope; helper vs documented semantics / parity drift / negative space; Planning / Premium gates / Execution precedence; plugin / install / update / SessionStart / bootstrap drift
...
### S026-F02 — A satisfied JIT trigger can be skipped by all-DONE Close routing
...
### S026-F03 — Declared commit/blob identities are trusted without verifying repository bytes
...
### S026-F04 — Planning remains executable after the current Definition revision changes
...
### S026-F05 — Close review reuse treats an acceptance-surface shrink as unchanged coverage
...
### S026-F06 — SessionStart accepts a semantically destroyed router when two marker strings survive
...
### S026-F07 — Active Research outranks a durable explicit user stop
...
#### S026 original confidence and limitations
...
## S027 — audit/pwv2-swarm-s06uaj47ohetuymvwvo8x0da

### S027-F01 — Satisfied JIT trigger is ignored and terminal Cards route to Close

- Source branch: `audit/pwv2-swarm-s06uaj47ohetuymvwvo8x0da`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: malformed or contradictory state / fail-closed behavior; helper vs documented semantics / parity drift / negative space; Task Board / READY / active / DONE / JIT-trigger lifecycle; router precedence / unreachable branches / conflicting obligations
...
### S027-F02 — DONE status bypasses REQUIRED/RED review gates
...
### S027-F03 — Claimed Git commit/blob identity is never verified against the bytes being finalized
...
### S027-F04 — Active Research masks an explicit user stop
...
#### S027 original confidence and limitations
...
## S028 — audit/pwv2-swarm-sdcia5015cuyksv7guxzxuw6

### S028-F01 — DONE status bypasses required review and RED/pending review blockers

- Source branch: `audit/pwv2-swarm-sdcia5015cuyksv7guxzxuw6`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: review independence / review bypass / result mutation; Task Board / READY / active / DONE / JIT-trigger lifecycle; malformed or contradictory state / fail-closed behavior; stale commit/blob/path/result/review identity
...
### S028-F02 — GREEN review can finalize a different current Task Card acceptance surface
...
### S028-F03 — commit/blob identity is not verified against file bytes, so same-path mutations pass
...
### S028-F04 — READY Card with an already durable result is accepted and routed toward replay
...
### S028-F05 — terminal implementation review attempts can be rewritten in place
...
#### S028 original confidence and limitations
...
## S029 — audit/pwv2-swarm-t1qv8efwb5ghlfht8sckdb1q

### S029-F01 — Exact Git identities are accepted without resolving commit/blob content

- Source branch: `audit/pwv2-swarm-t1qv8efwb5ghlfht8sckdb1q`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: 7. Planning / Premium gates / Execution precedence; 4. review independence / review bypass / result mutation; 3. stale commit/blob/path/result/review identity; 5. RED / recovery / blocker / interrupted-runtime continuation
...
### S029-F02 — Promoted Brainstorming explicit user stop is bypassed by Definition/Planning precedence
...
### S029-F03 — DONE status bypasses required implementation review and reaches Close
...
### S029-F04 — Stale Planning cycle survives a changed Definition revision
...
### S029-F05 — GREEN implementation review is reused after its Task Card acceptance surface mutates
...
#### S029 original confidence and limitations
...
## S030 — audit/pwv2-swarm-uppoz22buvceidlmlgxop9gg

### S030-F01 — DONE status bypasses result validity and required review before Close

- Source branch: `audit/pwv2-swarm-uppoz22buvceidlmlgxop9gg`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: RED / recovery / blocker / interrupted-runtime continuation; Planning / Premium gates / Execution precedence; Close / finalization / end-of-approved-scope; stale commit/blob/path/result/review identity
...
### S030-F02 — Exact Git subjects are trusted as strings instead of verified Git objects
...
### S030-F03 — Orphan implementation Research can preempt the Task Board without Board ownership
...
### S030-F04 — A human-authority blocker can coexist with in_progress and be ignored
...
#### S030 original confidence and limitations
...
## S031 — audit/pwv2-swarm-v59lpyq5jxrsgegtivvtk470

### S031-F01 — Immutable Git identities are self-attested instead of verified against artifact bytes

- Source branch: `audit/pwv2-swarm-v59lpyq5jxrsgegtivvtk470`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: stale commit/blob/path/result/review identity; helper vs documented semantics / parity drift / negative space; plugin / install / update / SessionStart / bootstrap drift; Planning / Premium gates / Execution precedence
...
### S031-F02 — Approved Planning is not bound to the current Definition revision/authority
...
### S031-F03 — Card-result “exact implementation subject” accepts arbitrary non-exact text
...
### S031-F04 — Missing result/review evidence is treated as durable proof
...
### S031-F05 — Plan Review acceptance can be unrelated to the Definition it supposedly reviews
...
#### S031 original confidence and limitations
...
## S032 — audit/pwv2-swarm-x9m2q7v4k1c8n5r0t6p3zjha

### S032-F01 — READY launch trusts self-asserted commit/blob metadata instead of verifying dependency content

- Source branch: `audit/pwv2-swarm-x9m2q7v4k1c8n5r0t6p3zjha`
- Original verdict context: FINDINGS FOUND — 4 material findings.
- Selected attack lenses: immutable-subject-and-content-identity; review-evidence-and-gate-integrity; router-precedence-and-real-stops; issue-diagnosis-prior-art-authorization-boundary
...
### S032-F02 — GREEN review can finalize with missing terminal evidence
...
### S032-F03 — Active Research masks an explicit user stop despite declared precedence
...
### S032-F04 — Arbitrary Intake string can bypass mandatory issue prior-art Research
...
#### S032 original confidence and limitations
...
## S033 — audit/pwv2-swarm-yc80f4r9jz0jn7b0vzdv424d

### S033-F01 — Durable explicit user stop can lose router precedence

- Source branch: `audit/pwv2-swarm-yc80f4r9jz0jn7b0vzdv424d`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: router precedence / unreachable branches / conflicting obligations; stale commit/blob/path/result/review identity; plugin / install / update / SessionStart / bootstrap drift; Task Board / READY / active / DONE / JIT-trigger lifecycle
...
### S033-F02 — Exact Git subjects are trusted as self-asserted strings instead of authenticated Git identity
...
### S033-F03 — Task Board status can bypass required review and can replay an already durable result
...
#### S033 original confidence and limitations
...
## S034 — audit/pwv2-swarm-ze8eya3df1xsxsb7q93smiac

### S034-F01 — A JIT trigger can be consumed without materializing its downstream Card, allowing Close to absorb unfinished approved work

- Source branch: `audit/pwv2-swarm-ze8eya3df1xsxsb7q93smiac`
- Original verdict context: FINDINGS FOUND
- Selected attack lenses: helper vs documented semantics / parity drift / negative space; Close / finalization / end-of-approved-scope; stale commit/blob/path/result/review identity; Task Board / READY / active / DONE / JIT-trigger lifecycle
...
### S034-F02 — DONE status bypasses the REQUIRED review gate
...
### S034-F03 — READY dependency refresh trusts declared commit/blob tuples without verifying the actual dependency bytes
...
### S034-F04 — A GREEN implementation review remains valid after its Task Card acceptance surface changes
...
### S034-F05 — Missing result and terminal-review evidence files do not block GREEN finalization
...
#### S034 original confidence and limitations
...
- No source finding was technically confirmed, rejected, repaired, or re-ranked as valid/invalid by this aggregation.
- Clustering is semantic normalization only and may itself require later verification or splitting/merging during technical triage.
- Frequency is evidence of independent rediscovery, not proof of validity.
- Unique findings are intentionally preserved and are not discounted for single-source frequency.
- Source reports and their persisted reproduction artifacts remain authoritative for their original details, exact wording, source-level confidence, and limitations.
- The aggregation used only persisted source audit reports/metadata/reproduction references for defect consolidation; it did not search the product implementation for new bugs.
- The frozen source set was enumerated exactly twice as specified. No indefinite polling occurred after the second enumeration.
- Two matching branches were retained explicitly as incomplete/empty and were not silently discarded.
